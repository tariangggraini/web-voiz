...
-- ------------------------------------------------------------
--  TABEL: status_log  (riwayat perubahan status)
-- ------------------------------------------------------------
...
--  Password: admin123
--  (hash bcrypt rounds=12 — ganti via Node setelah setup)
-- ------------------------------------------------------------
INSERT INTO users (nama, email, password_hash, role) VALUES
  ('Admin Voiz', 'admin@voiz.id',
   '$2b$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
   'admin');
-- Hash di atas = "password" (untuk testing)
-- Ganti dengan: node -e "require('bcrypt').hash('admin123',12,(_,h)=>console.log(h))"